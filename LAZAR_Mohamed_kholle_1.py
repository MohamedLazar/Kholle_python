...
parser.add_argument("--som", action="store_true", help="Affiche la somme des valeurs du csv")
parser.add_argument("-t", action="store_true", help="Trie la liste par ordre croissant")
parser.add_argument("--dec", action="store_true", help="Trie la liste par ordre décroissant")
...
def getSomValue():
    readCsv()
    liste_som = [int(n) for n in liste]
    value_som = som(liste_som)
    print(value_som)
